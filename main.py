...
def capture_video(display_flag=False,obj_to_detect="person",confidence=0.7,save_video_flag=False,save_image_flag=True):
    # Load YOLO model
    ...
    while cap.isOpened():
        ...
        # print(summary)
        for x in summary:
            if x["name"] == obj_to_detect and x["confidence"] > confidence:
